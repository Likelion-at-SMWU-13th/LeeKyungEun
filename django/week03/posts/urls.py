...
from .views import post_create_view, post_delete_view, post_form_view
from .views import post_list_view, post_update_view, post_detail_view, post_create_form_view
